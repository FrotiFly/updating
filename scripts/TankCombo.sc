...
run('/item replace entity @a armor.legs with minecraft:diamond_leggings{Enchantments:[{id:"minecraft:protection",lvl:5}]}');
run('/item replace entity @a armor.feet with minecraft:diamond_boots{Enchantments:[{id:"minecraft:protection",lvl:5}]}');
run('/item replace entity @a weapon.mainhand with minecraft:wooden_sword{Enchantments:[{id:"minecraft:sharpness",lvl:1}],Unbreakable:1b}');
