...
run('/item replace entity @a armor.head with minecraft:diamond_helmet{Enchantments:[{id:"minecraft:protection",lvl:5}]}');
run('/item replace entity @a armor.chest with minecraft:diamond_chestplate{Enchantments:[{id:"minecraft:protection",lvl:5}]}');
run('/item replace entity @a armor.legs with minecraft:iron_leggings{Enchantments:[{id:"minecraft:protection",lvl:5}]}');
run('/item replace entity @a armor.feet with minecraft:diamond_boots{Enchantments:[{id:"minecraft:protection",lvl:5}]}');
run('/item replace entity @a weapon.mainhand with minecraft:diamond_sword{Enchantments:[{id:"minecraft:sharpness",lvl:1}]}');
...
countdown() -> (
  ...
  global_counter += -1;	
	...
	if (global_counter < 0,
		...
		run('/effect clear @a');
		run('/effect give @a minecraft:speed 1000 1 true');
    );
